package com.crg.messengeripctest;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.button_request:
                if (mIsBind){
                    Message toServiceMessage = Message.obtain(null, COMING_FROM_CLIENT);
    ...
    private void bindRemoteService(){
        Intent intent = new Intent("android.intent.action.REMOTE_MESSENGER_SERVICE");
        intent.setPackage("com.crg.remoteservicemessenger");
